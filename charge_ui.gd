...
func _ready():
	...
	$SnapToRegimentCheckButton.toggled.connect(update_cursor_regiment_snap_setting)
...
func update_display():
	...
	# selected regiment
	$SnapToRegimentCheckButton.visible = UiStateMachine.ui_state_machine.is_charge_measure_state()
